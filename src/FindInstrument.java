...
//        properties.put("type", Type.ELECTRIC);
        ...
        List matchingInstruments = inventory.search(searchCriteria);

        if (!matchingInstruments.isEmpty()) {
            System.out.println(matchingInstruments.stream().count() + " instruments found:");
            for (Iterator i = matchingInstruments.iterator(); i.hasNext(); ) {
                Instrument instrument = (Instrument)i.next();
                InstrumentSpec spec = instrument.getSpec();
                System.out.println("Type: " + spec.getProperty("instrumentType") +
                        "   \nProperties: ");
            ...
            System.out.println("No matching instrument(s) found.");
        }
    }
